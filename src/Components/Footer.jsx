...
function Footer() {
  return (
    <>
     <MDBFooter bgColor='lg' className='text-center'>
      <section>
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md='3' lg='4' xl='3' className='mx-auto mb-4'>
              <h6 className='text-uppercase fw-bold mb-4'>
             <img src='https://imagedelivery.net/5MYSbk45M80qAwecrlKzdQ/04266e7f-007c-45fc-9930-aff9e733b300/public' height={'20px'} width={'10%'} alt=''></img>
             Video Player
              </h6>
              <p>
